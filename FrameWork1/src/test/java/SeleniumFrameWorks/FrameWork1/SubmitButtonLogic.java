...
public class SubmitButtonLogic {
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
		//Instead of writing above code we can simple call one method from SubmitButton by using page object model
		SubmitButton sb = new SubmitButton(driver);
		sb.getUrl();			
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
		//Instead of writing above code we can simple call one method from SubmitButton by using page object model
		//1. sb.loginDetailsAction();
		sb.loginDetailsAction("sravanipani1234@gmail.com", "Sravani@123");
